...
public class JMWCParticles {
    ...
    public static final Supplier<SimpleParticleType> ASPENTHINE_LEAVES =
            PARTICLE_TYPES.register("aspenthine_leaves", () -> new SimpleParticleType(false));
    public static final Supplier<SimpleParticleType> AUBRYN_HOLLOW_LEAVES =
    ...
    public static final Supplier<SimpleParticleType> BURRENBARK_LEAVES =
            PARTICLE_TYPES.register("burrenbark_leaves", () -> new SimpleParticleType(false));
    ...
    public static final Supplier<SimpleParticleType> CURSED_PETAL_LEAVES =
            PARTICLE_TYPES.register("cursed_petal_leaves", () -> new SimpleParticleType(false));
