...
public class JMWCBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock(((RotatedPillarBlock) JMWCBlocks.AGRABAH_CEDER_WOOD.get()),
                blockTexture(JMWCBlocks.AGRABAH_CEDER_LOG.get()), blockTexture(JMWCBlocks.AGRABAH_CEDER_LOG.get()));
        logBlock(((RotatedPillarBlock) JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG.get()));
        axisBlock(((RotatedPillarBlock) JMWCBlocks.STRIPPED_AGRABAH_CEDER_WOOD.get()),
                blockTexture(JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG.get()), blockTexture(JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG.get()));

        blockItem(JMWCBlocks.AGRABAH_CEDER_LOG);
        blockItem(JMWCBlocks.AGRABAH_CEDER_WOOD);
        blockItem(JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG);
        blockItem(JMWCBlocks.STRIPPED_AGRABAH_CEDER_WOOD);
        ...
        slabBlock(JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG_SLAB.get(), blockTexture(JMWCBlocks.STRIPPED_AGRABAH_CEDER_WOOD.get()), blockTexture(JMWCBlocks.STRIPPED_AGRABAH_CEDER_LOG.get()));
