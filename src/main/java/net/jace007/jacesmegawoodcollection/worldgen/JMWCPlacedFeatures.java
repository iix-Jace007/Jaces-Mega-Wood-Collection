...
public class JMWCPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> ALANTH_PLACED_KEY = registerKey("alanth_placed");
    ...
    public static final ResourceKey<PlacedFeature> BURRENBARK_PLACED_KEY = registerKey("burrenbark_placed");
    ...
    public static final ResourceKey<PlacedFeature> CURSED_PETAL_PLACED_KEY = registerKey("cursed_petal_placed");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, ALANTH_PLACED_KEY, configuredFeatures.getOrThrow(JMWCConfiguredFeatures.ALANTH_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        JMWCBlocks.ALANTH_SAPLING.get()));
        ...
        register(context, ASPENTHINE_PLACED_KEY, configuredFeatures.getOrThrow(JMWCConfiguredFeatures.ASPENTHINE_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        JMWCBlocks.ASPENTHINE_SAPLING.get()));
        register(context, AUBRYN_HOLLOW_PLACED_KEY, configuredFeatures.getOrThrow(JMWCConfiguredFeatures.AUBRYN_HOLLOW_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        JMWCBlocks.AUBRYN_HOLLOW_SAPLING.get()));
        ...
        register(context, BURRENBARK_PLACED_KEY, configuredFeatures.getOrThrow(JMWCConfiguredFeatures.BURRENBARK_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        JMWCBlocks.BURRENBARK_SAPLING.get()));
        ...
        register(context, CURSED_PETAL_PLACED_KEY, configuredFeatures.getOrThrow(JMWCConfiguredFeatures.CURSED_PETAL_KEY),
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2),
                        JMWCBlocks.CURSED_PETAL_SAPLING.get()));
