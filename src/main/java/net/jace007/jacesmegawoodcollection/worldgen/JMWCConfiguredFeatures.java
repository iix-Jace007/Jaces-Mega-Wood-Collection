...
public class JMWCConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> AUBRYN_HOLLOW_KEY = registerKey("aubryn_hollow");
    public static final ResourceKey<ConfiguredFeature<?, ?>> AUDRAFLORA_OAK_KEY = registerKey("audraflora_oak");
    public static final ResourceKey<ConfiguredFeature<?, ?>> BALLWYN_KEY = registerKey("ballwyn");
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ASPENTHINE_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                BlockStateProvider.simple(JMWCBlocks.ASPENTHINE_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
        register(context, AUBRYN_HOLLOW_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(JMWCBlocks.AUBRYN_HOLLOW_LOG.get()),
                    new StraightTrunkPlacer(3, 4, 2),
                BlockStateProvider.simple(JMWCBlocks.AUBRYN_HOLLOW_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
        register(context, AUDRAFLORA_OAK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                BlockStateProvider.simple(JMWCBlocks.AUDRAFLORA_OAK_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
        register(context, BALLWYN_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(JMWCBlocks.BALLWYN_LOG.get()),
                    new StraightTrunkPlacer(3, 4, 2),
                BlockStateProvider.simple(JMWCBlocks.BALLWYN_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
        register(context, BLACK_ABORA_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                BlockStateProvider.simple(JMWCBlocks.BLACK_ABORA_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
        register(context, BURRENBARK_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                BlockStateProvider.simple(JMWCBlocks.BURRENBARK_LOG.get()),
                    new StraightTrunkPlacer(3, 4, 2),
                BlockStateProvider.simple(JMWCBlocks.BURRENBARK_LEAVES.get()),
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(1), 3),
                    new TwoLayersFeatureSize(1, 0, 1)).build());
