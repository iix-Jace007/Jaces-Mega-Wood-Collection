...
public class JMWCBlocks {
    ...
    // Next Wood Types Caravan Olivewood, Copeland Cedar, Cursed Petal, Diamondfall Elm, Dollhouse Hickory, Dreamspire Alder, Empress Ash, Flashfire Walnut,
    // Flashflux Maple, Fracture Birch, Glowgrain Aspen, Goldflash Oak, Huntress Pine, Lone Wolf Walnut, Lyrelm, Marinth Oak, Moonclaw, Moonveil Aspen
    // Oracle Elm, Overdrive Ash, Panama City Pine, Pheneombark, Prismwood Ash, Redline Maple, Starstruck Spruce, Sugarthorn, techsprout Timber, Thicket Elm
    // Treetop Maple, Tulgeywood, Venomwood, and Vioak
