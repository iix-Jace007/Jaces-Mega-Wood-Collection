...
public class CopelandCedarLeaves extends JMWCLeaves {
    public CopelandCedarLeaves(BlockBehaviour.Properties properties) {
        super(properties);
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        client.addParticle(
                JMWCParticles.COPELAND_CEDAR_LEAVES.get(),
                x, y, z,
                vx, 0, vz
        );
    }
