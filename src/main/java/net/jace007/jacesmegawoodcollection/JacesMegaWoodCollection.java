...
import net.jace007.jacesmegawoodcollection.particle.custom.*;
...
@Mod(JacesMegaWoodCollection.MOD_ID)
public class JacesMegaWoodCollection {
    public static final String MOD_ID = "jacesmegawoodcollection";
    public static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public JacesMegaWoodCollection(IEventBus modEventBus, ModContainer modContainer) {
        ...
        JMWCParticles.register(modEventBus);
    ...
    public static class ClientModEvents {
        ...
        public static void registerParticleFactories(RegisterParticleProvidersEvent event ) {
            ...
            event.registerSpriteSet(JMWCParticles.ALANTH_LEAVES.get(), AlanthLeafParticles.Provider::new);
            event.registerSpriteSet(JMWCParticles.ALLMEN_OAK_LEAVES.get(), AllmenOakLeafParticles.Provider::new);
            event.registerSpriteSet(JMWCParticles.ASPENTHINE_LEAVES.get(), AspenthineLeafParticles.Provider::new);
            event.registerSpriteSet(JMWCParticles.AUBRYN_HOLLOW_LEAVES.get(), AubrynHollowLeafParticles.Provider::new);
            ...
            event.registerSpriteSet(JMWCParticles.CURSED_PETAL_LEAVES.get(), CursedPetalLeafParticles.Provider::new);
        }
    }
}